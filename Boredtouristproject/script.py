...
def get_attractions_for_traveler(traveler):
  ...
  for interest in traveler_attractions:
    interests_string += "the " + interest
  return interests_string
#note: traveler must be a list where traveler[0] = name, [1] = their destination and [2] = interests they hold
print(get_attractions_for_traveler(['Dereck Smill', 'Paris, France', ['monument']]))
# this test message should produce a welcome, include the traveler's name, the destination they are visiting, and what attractions we think they'd like.
